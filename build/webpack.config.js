...
// Ne splité pas les bundles pendant les test, car on veux juste importer un bundle
if (!__TEST__) {
  webpackConfig.plugins.push(
...
// Style Loaders
// ------------------------------------
// On utilise cssnano avec postcss loader, donc on peux appeler
// css-loader pour pas faire 2 minimization.
...
// ------------------------------------
// Quand on ne connait pas le public path (On le conanit que si le HMR est activé(en mode dev))
// nous pouvons utiliser extractTextPlugin pour fix ça :
